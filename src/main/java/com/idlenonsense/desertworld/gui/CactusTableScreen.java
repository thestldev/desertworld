...
public class CactusTableScreen extends AbstractRecipeScreenHandler<CraftingInventory> {
    private final CraftingInventory input = new CraftingInventory(this, 3, 3);
    private final CraftingResultInventory result = new CraftingResultInventory();
    private final ScreenHandlerContext context;
    private final PlayerEntity player;

    public CactusTableScreen(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public CactusTableScreen(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, ModBlocks.CACTUS_TABLE);
    }
